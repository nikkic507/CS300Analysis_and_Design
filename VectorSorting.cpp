...
void selectionSort(vector<Bid>& bids) {
    ...
    for (unsigned j = po +1; j < size_t; ++j){
...
int main(int argc, char* argv[]) {
    ...
    while (choice != 9) {
        ...
        case 3:
        	//initialize at timer variable before loading bid
        	ticks = clock();
        	// complete the method call to load bids
        	selectionSort(bids);
        ...
        case 4:
        	...
        	// calculate elapsed time and display result
        	ticks = clock() - ticks; //current clock ticks minues starting clock ticks
        	cout << "time: " << ticks << " clock ticks" << endl;
        	cout << "time: " << ticks * 1.0 / CLOCK_PER_SEC << " seconds" << endl;
